...
module.exports.profilePhotoUploadCtrl = asyncHandler(async (req, res) => {
  // 1. Validation
  if (!req.file) {
    return res.status(400).json({ message: "Nie podano pliku" });
  }
  ...
  res.status(200).json({
    message: "Twoje zdjęcie profilowe zostało pomyślnie przesłane",
...
module.exports.deleteUserProfileCtrl = asyncHandler(async (req, res) => {
  ...
  res.status(200).json({ message: "Profil został usunięty" });
});
